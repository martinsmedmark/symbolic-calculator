...
public class TestRunner{
    ...
    public void createParser(){
        this.pars = new Parser(System.in);
    }
    @After
    ...
    public void testVars(){
        ...
        String d3 = (e3.eval(variables)).getName();
        //  new Array(d1, d2, d3);
        //assertEquals()
    }
    ...
    public void testParserAddition() {
        ...
        try {
            ...
            try {
                ...
                assertEquals(e.toString(), "1.0+1.0");
    ...
    public void testParserMultiplication() {
        ...
        @Test
    public void testParserSin() {
        String testAddition = "sin(1)";
        ...
        try {
            ...
            try {
                Sexpr e = p.statement();
                System.out.println("Read expression: "+  e);
                assertEquals(e.toString(), "Sin(1.0)");
    ...
    @Test
    public void testParserPriority() {
        String testAddition = "5*(1+1)";
        ...
        try {
            ...
            try {
                Sexpr e = p.statement();
                System.out.println("Read expression: "+  e);
                assertEquals(e.toString(), "5.0*1.0+1.0");
